...
import { PartSubCategoryDeleteDialog } from './part-sub-category-delete-dialog';

describe('PartSubCategory Management Delete Component', () => {
  let comp: PartSubCategoryDeleteDialog;
  let fixture: ComponentFixture<PartSubCategoryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PartSubCategoryDeleteDialog);
