...
import { MegaSetPartCountDeleteDialog } from './mega-set-part-count-delete-dialog';

describe('MegaSetPartCount Management Delete Component', () => {
  let comp: MegaSetPartCountDeleteDialog;
  let fixture: ComponentFixture<MegaSetPartCountDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaSetPartCountDeleteDialog);
