...
import { MegaAttributeDeleteDialog } from './mega-attribute-delete-dialog';

describe('MegaAttribute Management Delete Component', () => {
  let comp: MegaAttributeDeleteDialog;
  let fixture: ComponentFixture<MegaAttributeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaAttributeDeleteDialog);
