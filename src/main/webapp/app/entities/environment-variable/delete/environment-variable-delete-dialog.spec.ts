...
import { EnvironmentVariableDeleteDialog } from './environment-variable-delete-dialog';

describe('EnvironmentVariable Management Delete Component', () => {
  let comp: EnvironmentVariableDeleteDialog;
  let fixture: ComponentFixture<EnvironmentVariableDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EnvironmentVariableDeleteDialog);
