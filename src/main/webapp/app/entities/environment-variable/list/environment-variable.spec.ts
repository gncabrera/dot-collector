...
import { sampleWithRequiredData } from '../environment-variable.test-samples';
...
describe('EnvironmentVariable Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: EnvironmentVariable;
  let fixture: ComponentFixture<EnvironmentVariable>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EnvironmentVariable);
  ...
  it('should call load all on init', async () => {
    ...
    expect(comp.environmentVariables()[0]).toEqual(expect.objectContaining({ id: 22355 }));
  });

  describe('trackId', () => {
    it('should forward to environmentVariableService', () => {
      const entity = { id: 22355 };
      vitest.spyOn(service, 'getEnvironmentVariableIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEnvironmentVariableIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.environmentVariablesParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
