...
import profileCollectionSetResolve from './profile-collection-set-routing-resolve.service';

describe('ProfileCollectionSet routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IProfileCollectionSet returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          profileCollectionSetResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(profileCollectionSetResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
