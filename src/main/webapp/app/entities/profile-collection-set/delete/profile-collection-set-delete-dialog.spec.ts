...
import { ProfileCollectionSetDeleteDialog } from './profile-collection-set-delete-dialog';

describe('ProfileCollectionSet Management Delete Component', () => {
  let comp: ProfileCollectionSetDeleteDialog;
  let fixture: ComponentFixture<ProfileCollectionSetDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProfileCollectionSetDeleteDialog);
