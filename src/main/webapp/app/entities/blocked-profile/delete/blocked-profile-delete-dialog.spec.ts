...
import { BlockedProfileDeleteDialog } from './blocked-profile-delete-dialog';

describe('BlockedProfile Management Delete Component', () => {
  let comp: BlockedProfileDeleteDialog;
  let fixture: ComponentFixture<BlockedProfileDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BlockedProfileDeleteDialog);
