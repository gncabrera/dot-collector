...
import { ProfileRequestDeleteDialog } from './profile-request-delete-dialog';

describe('ProfileRequest Management Delete Component', () => {
  let comp: ProfileRequestDeleteDialog;
  let fixture: ComponentFixture<ProfileRequestDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProfileRequestDeleteDialog);
