...
import { MegaAttributeOptionDeleteDialog } from './mega-attribute-option-delete-dialog';

describe('MegaAttributeOption Management Delete Component', () => {
  let comp: MegaAttributeOptionDeleteDialog;
  let fixture: ComponentFixture<MegaAttributeOptionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaAttributeOptionDeleteDialog);
