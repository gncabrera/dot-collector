...
import { ProfileCollectionDeleteDialog } from './profile-collection-delete-dialog';

describe('ProfileCollection Management Delete Component', () => {
  let comp: ProfileCollectionDeleteDialog;
  let fixture: ComponentFixture<ProfileCollectionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ProfileCollectionDeleteDialog);
