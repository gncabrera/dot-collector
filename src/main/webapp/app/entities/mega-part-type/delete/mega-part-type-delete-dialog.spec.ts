...
import { MegaPartTypeDeleteDialog } from './mega-part-type-delete-dialog';

describe('MegaPartType Management Delete Component', () => {
  let comp: MegaPartTypeDeleteDialog;
  let fixture: ComponentFixture<MegaPartTypeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaPartTypeDeleteDialog);
