...
import { MegaAssetDeleteDialog } from './mega-asset-delete-dialog';

describe('MegaAsset Management Delete Component', () => {
  let comp: MegaAssetDeleteDialog;
  let fixture: ComponentFixture<MegaAssetDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaAssetDeleteDialog);
