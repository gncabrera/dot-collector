...
import { MegaPartDeleteDialog } from './mega-part-delete-dialog';

describe('MegaPart Management Delete Component', () => {
  let comp: MegaPartDeleteDialog;
  let fixture: ComponentFixture<MegaPartDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaPartDeleteDialog);
