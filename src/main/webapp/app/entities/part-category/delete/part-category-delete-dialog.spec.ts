...
import { PartCategoryDeleteDialog } from './part-category-delete-dialog';

describe('PartCategory Management Delete Component', () => {
  let comp: PartCategoryDeleteDialog;
  let fixture: ComponentFixture<PartCategoryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PartCategoryDeleteDialog);
