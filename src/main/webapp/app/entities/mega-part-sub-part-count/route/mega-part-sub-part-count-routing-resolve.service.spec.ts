...
import megaPartSubPartCountResolve from './mega-part-sub-part-count-routing-resolve.service';

describe('MegaPartSubPartCount routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IMegaPartSubPartCount returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          megaPartSubPartCountResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
    ...
    it('should route to 404 page if data not found in server', async () => {
      ...
      await TestBed.runInInjectionContext(async () => {
        await expect(lastValueFrom(megaPartSubPartCountResolve(mockActivatedRouteSnapshot))).rejects.toThrowError(
