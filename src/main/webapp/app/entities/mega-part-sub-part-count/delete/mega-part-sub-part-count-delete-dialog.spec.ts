...
import { MegaPartSubPartCountDeleteDialog } from './mega-part-sub-part-count-delete-dialog';

describe('MegaPartSubPartCount Management Delete Component', () => {
  let comp: MegaPartSubPartCountDeleteDialog;
  let fixture: ComponentFixture<MegaPartSubPartCountDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaPartSubPartCountDeleteDialog);
