...
import { MegaSetTypeDeleteDialog } from './mega-set-type-delete-dialog';

describe('MegaSetType Management Delete Component', () => {
  let comp: MegaSetTypeDeleteDialog;
  let fixture: ComponentFixture<MegaSetTypeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MegaSetTypeDeleteDialog);
